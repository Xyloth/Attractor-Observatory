# Dossier: `atlas/status_viewer/renderer.py`
...
## Current
- Status: `recovered`
- Public symbols: `render_campaign006_atlas`
...
## Findings
- **PG-atlas/status_viewer/renderer.py-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
