# Dossier: `reports/campaign_004/guidance_negative_biology.json`
...
## Findings
- **PG-reports/campaign_004/guidance_negative_biology.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
