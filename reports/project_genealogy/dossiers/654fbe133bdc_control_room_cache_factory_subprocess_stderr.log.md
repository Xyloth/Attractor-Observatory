# Dossier: `control_room/cache/factory_subprocess_stderr.log`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/654fbe133bdc_control_room_cache_factory_subprocess_stderr.log.json`
- JSON content_hash: `sha256:f26d2b1f56c8fd6c3d770ca54484975d0d68f9e821787626d9f363d8c6e03df3`
...
## Findings
- **PG-control_room/cache/factory_subprocess_stderr.log-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
