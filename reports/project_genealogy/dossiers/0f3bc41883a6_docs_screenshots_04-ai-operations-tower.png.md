# Dossier: `docs/screenshots/04-ai-operations-tower.png`
...
## Current
- Status: `recovered`
- Observed doctrines: `D0, D1, D2, D3, D4, D5, D7, D9`

## DepthVector.v1
- **predicate_atom_coverage**: `{'claimable_atoms': 1, 'covered_atoms': 1, 'missing_atoms': [], 'value': 1.0}`
- **adversarial_surface_coverage**: `{'required_bad_cases': [], 'covered_bad_cases': [], 'missing_bad_cases': [], 'value': None}`
- **doctrine_binding_quality**: `{'required': ['D0', 'D1', 'D2', 'D3', 'D4', 'D5', 'D7', 'D9'], 'verified': ['D0', 'D1', 'D2', 'D3', 'D4', 'D5', 'D7', 'D9'], 'claimed_only': [], 'missing': [], 'contradicted': [], 'not_applicable': []}`
