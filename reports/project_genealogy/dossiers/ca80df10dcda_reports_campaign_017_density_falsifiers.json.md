# Dossier: `reports/campaign_017/density_falsifiers.json`
...
## Findings
- **PG-reports/campaign_017/density_falsifiers.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
