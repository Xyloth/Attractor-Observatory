# Dossier: `reports/campaign_002/raf_benchmarks.json`
...
## Findings
- **PG-reports/campaign_002/raf_benchmarks.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
