# Dossier: `CONTRIBUTING.md`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/eca12c0a30e2_CONTRIBUTING.md.json`
- JSON content_hash: `sha256:3edd384cfcb94ac87ef4688a4fdcc067c539df63511659d376a7ba3beed58d60`
...
## Current
- Status: `recovered`
- Observed doctrines: `D18, D7`

## DepthVector.v1
- **predicate_atom_coverage**: `{'claimable_atoms': 1, 'covered_atoms': 1, 'missing_atoms': [], 'value': 1.0}`
- **adversarial_surface_coverage**: `{'required_bad_cases': [], 'covered_bad_cases': [], 'missing_bad_cases': [], 'value': None}`
- **doctrine_binding_quality**: `{'required': ['D18', 'D7'], 'verified': ['D18', 'D7'], 'claimed_only': [], 'missing': [], 'contradicted': [], 'not_applicable': []}`
