# Dossier: `papers/methods/SUBSTANCE_AUDIT_W9.md`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/ae3a1d224daa_papers_methods_SUBSTANCE_AUDIT_W9.md.json`
- JSON content_hash: `sha256:f450980133afc398c1dbc8ea7f3eca12a2210a628342b8dc642e151e90479c56`
...
- **header_declared_intent** — # Substance Audit W9 Origins Chemistry
Campaign: 008
Doctrine: D17.5
...
- Transport limitation: pore-to-pore diffusion and optional fully mixed controls exp
...
## Findings
- **PG-papers/methods/SUBSTANCE_AUDIT_W9.md-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
