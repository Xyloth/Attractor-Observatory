# Dossier: `factory_lowlevel/schemas.py`
...
## Current
- Status: `recovered`
- Public symbols: `AuditQueueItem, EmpiricalRecord, EvidenceEdge, NormalizedReference, SourceCacheEntry, SourceDefinition, canonical_json, sha256, utc_now`
...
## Findings
- **PG-factory_lowlevel/schemas.py-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
