# Dossier: `atlas/negative_space/NS-C004-07-digital_parasite_locked_replication.json`
...
## Findings
- **PG-atlas/negative_space/NS-C004-07-digital_parasite_locked_replication.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
