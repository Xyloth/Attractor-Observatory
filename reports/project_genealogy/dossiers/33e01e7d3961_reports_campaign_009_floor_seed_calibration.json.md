# Dossier: `reports/campaign_009/floor_seed_calibration.json`
...
- **operational_load_bearingness**: `{'imports_in': 0, 'imports_out': 0, 'generates_artifacts': [], 'validated_by': [], 'cited_by_reports': ['CODEX_TASK_020_DRIVE.md', 'Proposal #1 v2 - Basin-Floor Geometry.md', 'reports/campaign_009/cli_full_report.json', 'reports/campaign_009/full_report.json', 'reports/campaign_023/full_report.json', 'reports/campaign_024/full_report.json', 'reports/campaign_026/full_report.json'], 'weighted_value': 10.5}`
...
## Findings
- **PG-reports/campaign_009/floor_seed_calibration.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
