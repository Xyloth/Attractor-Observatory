# Dossier: `reports/campaign_006/negative_space.json`
...
## Findings
- **PG-reports/campaign_006/negative_space.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
