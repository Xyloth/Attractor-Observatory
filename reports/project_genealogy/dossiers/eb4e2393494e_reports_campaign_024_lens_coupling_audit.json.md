# Dossier: `reports/campaign_024/lens_coupling_audit.json`
...
- **operational_load_bearingness**: `{'imports_in': 0, 'imports_out': 0, 'generates_artifacts': [], 'validated_by': [], 'cited_by_reports': ['BUILD_LOG.md', 'reports/task_dx002_public_boundary_markers.json'], 'weighted_value': 3.0}`
...
## Findings
- **PG-reports/campaign_024/lens_coupling_audit.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
