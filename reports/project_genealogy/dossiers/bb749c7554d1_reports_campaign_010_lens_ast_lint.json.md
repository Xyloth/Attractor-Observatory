# Dossier: `reports/campaign_010/lens_ast_lint.json`
...
## Findings
- **PG-reports/campaign_010/lens_ast_lint.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
