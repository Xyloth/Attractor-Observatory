# Dossier: `reports/campaign_013/itis_insect_extraction.json`
...
## Findings
- **PG-reports/campaign_013/itis_insect_extraction.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
