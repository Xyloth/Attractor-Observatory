# Dossier: `reports/campaign_009/perturbation_budget.json`
...
- **operational_load_bearingness**: `{'imports_in': 0, 'imports_out': 0, 'generates_artifacts': [], 'validated_by': [], 'cited_by_reports': ['CODEX_TASK_020_DRIVE.md', 'Proposal #1 v2 - Basin-Floor Geometry.md'], 'weighted_value': 3.0}`
...
## Findings
- **PG-reports/campaign_009/perturbation_budget.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
