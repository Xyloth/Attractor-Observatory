# Dossier: `control_room/cache/task033_streamlit_stdout.log`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/87af28e9a885_control_room_cache_task033_streamlit_stdout.log.json`
- JSON content_hash: `sha256:45efa234841a86f5f900c58b194012f14fadcc7599a947e65ba4148369e1dc13`
...
## Findings
- **PG-control_room/cache/task033_streamlit_stdout.log-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
