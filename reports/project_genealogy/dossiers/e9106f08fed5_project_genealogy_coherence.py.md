# Dossier: `project_genealogy/coherence.py`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/e9106f08fed5_project_genealogy_coherence.py.json`
- JSON content_hash: `sha256:59dce9acc046b0bc176d1252e7e4e530786c71fb5504588fbfa218e4b07cc470`
- Schema: `ProjectGenealogyDossier.v1`
- Artifact family: `audit_instrument`
- Generated status: `source`
- Lines: 257 / Bytes: 10049
...
## Current
- Status: `recovered`
- Public symbols: `build_coherence, write_coherence`
...
## Findings
- **PG-project_genealogy/coherence.py-lvs-0** (info, hypothesis): Detected letter-coupled fix surface at line 92: if status == "orphan":
- **PG-project_genealogy/coherence.py-lvs-1** (info, hypothesis): Detected letter-coupled fix surface at line 183: if traj_status == "insufficient_history":
- **PG-project_genealogy/coherence.py-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
