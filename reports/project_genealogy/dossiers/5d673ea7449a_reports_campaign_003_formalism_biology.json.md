# Dossier: `reports/campaign_003/formalism_biology.json`
...
## Findings
- **PG-reports/campaign_003/formalism_biology.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
