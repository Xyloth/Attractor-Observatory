# Dossier: `atlas/negative_space/NS-C006-10-w4-informative.json`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/baceabc99962_atlas_negative_space_NS-C006-10-w4-informative.json.json`
- JSON content_hash: `sha256:c778889a85eb20095a1a3de8704de9354496ea2840c8389990c4a77116e76992`
...
## Findings
- **PG-atlas/negative_space/NS-C006-10-w4-informative.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
