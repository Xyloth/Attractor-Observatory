# Dossier: `docs/doctrine_d28.md`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/fba06aac4611_docs_doctrine_d28.md.json`
- JSON content_hash: `sha256:d886647c45cac43336f7775a81ccb8131a0461de36a6fa56ee82f20fcd0fee98`
...
- **header_declared_intent** — # Doctrine D28 - Release Boundary
Mode: foundational
...
`audit_live_at` or equivalent public-

## Current
- Status: `recovered`
- Observed doctrines: `D27, D28`

## DepthVector.v1
- **predicate_atom_coverage**: `{'claimable_atoms': 2, 'covered_atoms': 2, 'missing_atoms': [], 'value': 1.0}`
- **adversarial_surface_coverage**: `{'required_bad_cases': [], 'covered_bad_cases': [], 'missing_bad_cases': [], 'value': None}`
- **doctrine_binding_quality**: `{'required': ['D27', 'D28'], 'verified': ['D27', 'D28'], 'claimed_only': [], 'missing': [], 'contradicted': [], 'not_applicable': []}`
...
## Findings
- **PG-docs/doctrine_d28.md-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
