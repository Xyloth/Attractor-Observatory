# Dossier: `reports/campaign_002/boundary_detector_calibration.json`
...
## Findings
- **PG-reports/campaign_002/boundary_detector_calibration.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
