# Dossier: `papers/prereg/campaign_002.signed.json`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/751c5a6274a0_papers_prereg_campaign_002.signed.json.json`
- JSON content_hash: `sha256:7baa71169570e158832924359a01c83d93755609af7be0250d2ddc0f231afdbd`
...
- **operational_load_bearingness**: `{'imports_in': 0, 'imports_out': 0, 'generates_artifacts': [], 'validated_by': [], 'cited_by_reports': ['CODEX_TASK_009_DRIVE.md', 'reports/campaign_002/full_report.json', 'reports/task_cb022_evidence_discipline/path_reference_markers.json'], 'weighted_value': 4.5}`
...
## Findings
- **PG-papers/prereg/campaign_002.signed.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
