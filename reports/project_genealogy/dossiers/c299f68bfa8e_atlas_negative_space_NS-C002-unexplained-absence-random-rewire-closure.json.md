# Dossier: `atlas/negative_space/NS-C002-unexplained-absence-random-rewire-closure.json`
...
"entry_id": "NS-C002-unexplained-absence-random-rewire-closure",
"evidence": [
"reports/campaign_002/nulls/N0.json",
"reports/campaign_002/nulls/N2.json"
],
"kind": "unexplained_absence",
"owner": "Architect",
"rationale": "The RAF lens allows rare random closures in principle, but N0/N2 did not produce a null confidence at or above the transfer signal.",
"spec_sec
...
## Findings
- **PG-atlas/negative_space/NS-C002-unexplained-absence-random-rewire-closure.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
