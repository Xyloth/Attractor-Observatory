# Dossier: `control_room/cache/factory_subprocess_stdout.log`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/7134480b0b0d_control_room_cache_factory_subprocess_stdout.log.json`
- JSON content_hash: `sha256:9d39fc8f2187d370ccbb814fedae96a1eafcab1d2f36d4ac539a985efb915069`
...
## Findings
- **PG-control_room/cache/factory_subprocess_stdout.log-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
