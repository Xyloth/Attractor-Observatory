# Dossier: `reports/campaign_018/bridge_traces.json`
...
## Findings
- **PG-reports/campaign_018/bridge_traces.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
