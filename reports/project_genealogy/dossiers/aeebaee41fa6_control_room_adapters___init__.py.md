# Dossier: `control_room/adapters/__init__.py`

> JSON is authoritative. This file is a rendering of the JSON dossier.

- JSON: `reports/project_genealogy/dossiers/aeebaee41fa6_control_room_adapters___init__.py.json`
- JSON content_hash: `sha256:56b107635d2eec8303d54ae0033f9006696d06337ee4be77028b87674bd1acd9`
...
## Current
- Status: `recovered`
- Public symbols: `adapter_status_values`
...
- **operational_load_bearingness**: `{'imports_in': 40, 'imports_out': 0, 'generates_artifacts': [], 'validated_by': [], 'cited_by_reports': [], 'weighted_value': 80.0}`
