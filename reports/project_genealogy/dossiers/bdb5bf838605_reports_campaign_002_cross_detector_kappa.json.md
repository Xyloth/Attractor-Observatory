# Dossier: `reports/campaign_002/cross_detector_kappa.json`
...
## Findings
- **PG-reports/campaign_002/cross_detector_kappa.json-drift-review** (medium, hypothesis): Drift requires review: missing or new atoms or letter-vs-spirit surfaces present without yet crossing a doctrine boundary.
